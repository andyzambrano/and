document.addEventListener("DOMContentLoaded", function () {
    ...
    const titlesU = document.querySelectorAll(".titu");
    ...
    // Ocultar la información, los cuadros, "tit" y "titu"
    ...
    titlesU.forEach((title) => title.style.visibility = "hidden");
    ...
    check.addEventListener("change", function () {
        if (this.checked) {
            ...
            // Mostrar la información, los cuadros, "tit" y "titu"
            ...
            titlesU.forEach((title) => title.style.visibility = "visible");
        } else {
